...
output_directory="/lustre/scratch115/projects/psc2020/COLOC_RESULTS/IBD2017/neutrophil_counts/"
output_filename=paste(output_directory,snp_of_interest,".",toupper(trait),".neutrophil_counts.coloc.results",sep="")
...
second_dataset=read.table(paste("/lustre/scratch115/projects/psc2020/splitfiles/neutrophil_counts_summary_stats/neut_N170702_narrow.Chr_",chrom,".sorted.txt",sep=""),head=T,sep="\t")

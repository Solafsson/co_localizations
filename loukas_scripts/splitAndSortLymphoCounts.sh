#!/bin/bash
t1dcc="/lustre/scratch115/projects/psc2020/splitfiles/lymphocyte_counts_summary_stats/lymph_N171643_narrow_form.tsv"

outputcc="/lustre/scratch115/projects/psc2020/splitfiles/lymphocyte_counts_summary_stats/lymph_N171643_narrow"
for((i=1;i<=22;i++));
do
...
cat ${t1dcc} | awk -v chr=$i '{split($8,arr,">");if($3==chr){ print $3"\t"$4"\t"$2"\t"$11"\t"exp($9)"\t"$5"\t"$6"\t"173480"\t"$14}}' > ${outputcc}.Chr_${i}.tmp

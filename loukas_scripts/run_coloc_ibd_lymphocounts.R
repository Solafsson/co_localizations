...
output_directory="/lustre/scratch115/projects/psc2020/COLOC_RESULTS/IBD2017/lymphocyte_counts/"
output_filename=paste(output_directory,snp_of_interest,".",toupper(trait),".lymphocyte_counts.coloc.results",sep="")
...
second_dataset=read.table(paste("/lustre/scratch115/projects/psc2020/splitfiles/lymphocyte_counts_summary_stats/lymph_N171643_narrow.Chr_",chrom,".sorted.txt",sep=""),head=T,sep="\t")
